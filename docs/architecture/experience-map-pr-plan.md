...
✅ 는 통합 브랜치 머지 완료. **진행 상황은 GitHub 이슈 #301·#305~#310 에서 봅니다** — 문서에 스냅샷을 두면 금방 낡습니다.
...
**이제 외부-A가 유일한 임계 경로입니다.** 외부-C(`slot_id` 목록)는 2026-08-09에
해소됐습니다. 메인 DB migration이 없으면 EM-04·EM-05가 막히고, 그 뒤로 EM-10과
노드 체인 전체가 밀립니다.

...
5. 인사이트 문장을 그대로 복붙하거나 제목/본문을 원문 그대로 노출하지 마세요
6. 친근하지만 격식 있는 어조를 유지하세요
7. 질문만 출력하고, 다른 설명은 추가하지 마세요
...
6. 너무 많은 정보를 한 번에 묻지 마세요 (1~2개 필드에 집중)
7. 친근하지만 격식 있는 어조를 유지하세요
8. 질문만 출력하고, 다른 설명은 추가하지 마세요
# 예시
[나쁜 예시]

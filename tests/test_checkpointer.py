...
from common.checkpointer.factory import (
    get_checkpointer,
    reset_checkpointer,
    setup_checkpointer,
)
...
@pytest.mark.asyncio
async def test_get_checkpointer_creates_directory(tmp_path, monkeypatch):
...
@pytest.mark.asyncio
async def test_reset_checkpointer_returns_new_instance(tmp_path, monkeypatch):
...
@pytest.mark.asyncio
async def test_get_checkpointer_default_path_creates_data_dir(tmp_path, monkeypatch):
